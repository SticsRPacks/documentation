...
# 
# # if you have some problems "allocating vectors" try to run the benchmark with only one command and save the result
# 
# # multi_tb <- create_tibble3(USM_list_1996,1,500000,sim_data_289)
# # benchmark_multi_1_tb <- microbenchmark(tb = tibble_get_usm_names_and_var_values(multi_tb,1,"resmes","1996-01-05"),
# #                                     times = 10)
# # # save data !
# # save(file = paste0(multi_name,"1_tibble.RData"), list = "benchmark_multi_1_tb")
# 
# 
# # multi_li <- create_list2(USM_list_1996,1,500000,sim_data_289)
# # benchmark_multi_1_li <- microbenchmark(li = list_get_usm_names_and_var_values2(multi_li,1,"resmes","1996-01-05"),
# #                                     times = 10)
# # # save data !
# # save(file = paste0(multi_name,"1_list.RData"), list = "benchmark_multi_1_li")
# 
# gc()
# 
