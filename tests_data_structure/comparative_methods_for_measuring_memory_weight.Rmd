...
for (i in size) {
  liste <- vector_usm_list(i)
  classe <- vector_usm_class(i)
  df <- vector_usm_dataframe(i)
  dt <- vector_usm_datatable(i)
  tb <- vector_usm_tibble(i)
  ...
  print(global_graph_weight_recap + ggtitle(sprintf("%s %d","weight meausre method recap graph for size =",i)))
}
