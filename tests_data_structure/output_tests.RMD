...
benchmark <- microbenchmark(tb1_1 = create_tibble(USM_list_1996,5,10,sim_data),
                            tb1_2 = create_tibble(USM_list_1996,10,10,sim_data),
                            tb1_3 = create_tibble(USM_list_1996,50,10,sim_data),
                            li1_1 = create_list(USM_list_1996,5,10,sim_data),
                            li1_2 = create_list(USM_list_1996,10,10,sim_data),
                            li1_3 = create_list(USM_list_1996,50,10,sim_data),
                            tb2_1 = create_tibble2(USM_list_1996,5,10,sim_data),
                            tb2_2 = create_tibble2(USM_list_1996,10,10,sim_data),
                            tb2_3 = create_tibble2(USM_list_1996,50,10,sim_data),
                            li2_1 = create_list2(USM_list_1996,5,10,sim_data),
                            li2_2 = create_list2(USM_list_1996,10,10,sim_data),
                            li2_3 = create_list2(USM_list_1996,50,10,sim_data),
                            times = 100)
...
# DOE, usm_number
opti_tb1 <- create_tibble(USM_list_1996,50,10,sim_data)
multi_tb1 <- create_tibble(USM_list_1996,1,500,sim_data)
analysis_tb1 <- create_tibble(USM_list_1996,50,10,sim_data)
opti_tb2 <- create_tibble2(USM_list_1996,50,10,sim_data)
multi_tb2 <- create_tibble2(USM_list_1996,1,500,sim_data)
analysis_tb2 <- create_tibble2(USM_list_1996,50,10,sim_data)

opti_li1 <- create_list(USM_list_1996,50,10,sim_data)
multi_li1 <- create_list(USM_list_1996,1,500,sim_data)
analysis_li1 <- create_list(USM_list_1996,50,10,sim_data)
opti_li2 <- create_list2(USM_list_1996,50,10,sim_data)
multi_li2 <- create_list2(USM_list_1996,1,500,sim_data)
analysis_li2 <- create_list2(USM_list_1996,50,10,sim_data)
```
...
benchmark_opti <- microbenchmark(tb1 = tibble_get_dates_and_var_values(opti_tb1,1,"bo96iN+_2","HR_1"),
                                 tb2 = tibble_get_dates_and_var_values(opti_tb2,1,"bo96iN+_2","HR_1"),
                                 li1 = list_get_dates_and_var_values(opti_li1,1,"bo96iN+_2","HR_1"),
                                 li2 = list_get_dates_and_var_values(opti_li2,1,"bo96iN+_2","HR_1"),
                                 times = 100)
...
benchmark_multi <- microbenchmark(tb1 = tibble_get_usm_names_and_var_values(multi_tb1,1,"HR_4","1996-01-05"),
                                  tb2 = tibble_get_usm_names_and_var_values(multi_tb2,1,"HR_4","1996-01-05"),
                                  li1 = list_get_usm_names_and_var_values(multi_li1,1,"HR_4","1996/01/05-00/00/00"),
                                  li2 = list_get_usm_names_and_var_values(multi_li2,1,"HR_4","1996/01/05-00/00/00"),
                                  times = 100)
...
benchmark_analysis <- microbenchmark(tb1 = tibble_get_DOE_and_var_values(analysis_tb1,"bo96iN+_2","HR_3","1996-01-05"),
                                     tb2 = tibble_get_DOE_and_var_values(analysis_tb2,"bo96iN+_2","HR_3","1996-01-05"),
                                     li1 = list_get_DOE_and_var_values(analysis_li1,"bo96iN+_2","HR_3",
                                                                      "1996/01/05-00/00/00"),
                                     li2 = list_get_DOE_and_var_values(analysis_li2,"bo96iN+_2","HR_3",
                                                                      "1996/01/05-00/00/00"),
                                     times = 100)
