...
**SHOULD BE A NAMED VECTOR (param1=1, param2=2, ...)** 
...
**Tes noms de variables ne sont pas très explicite : usm_sugarCane pour la liste, Sugarcane pour la class, df pour data.frame, tb, et dt ...**
