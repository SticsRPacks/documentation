...
# we get the first usm (there are 15 elements in one usm)
test[1:15]

# we get the first usm's name
test[1:15]$name

# we get the usms' names (here there are 2 usm) using their index
test[1]
test[16]

# we try to get all the usms' names
test$name
# but it's not working and gives the first usm's name
