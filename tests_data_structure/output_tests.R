...
# taille max : 15.8 Go (DoE -> 50K, Usms -> 446). Au dela de 446 Usms -> erreur : vecteur de longeur n�gative interdite
# meme en allouant 16Go de m�moire, j'obtiens l'erreur :impossible d'allouer un vecteur de taille 15.8 Go
# opti_tb <- create_tibble2(USM_list_1996,50000,446,sim_data)
# opti_tb
# gc() 

# taille : 735 Mo
# La aussi, j'obtiens l'erreur : impossible d'allouer un vecteur de taille 735.0 Mo alors que j'overkill le besoin m�moire
