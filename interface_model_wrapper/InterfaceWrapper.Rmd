...
Dans ces deux derniers cas, l'utilisateur devra par contre lui-même extraire les résultats qui l'intéressent en termes de variables et de dates.
...
#  Runs the lai_toymodel for a set of situations defined in sit_names (if given) or model_options (year, jul_beg, jul_end),
#  Forces the lai_toymodel parameters A, x1 and x3 with the values given in param_values argument 
#   (that may depend on the situation to simulate)  
