...
params:
  ...
  path_to_JavaStics: "C:/Users/Thomas/Documents/GitHub/SticsRTests/inst/stics/JavaSTICS-1.41-stics-9.0"
  result_path: "C:/Users/Thomas/Documents/GitHub/documentation/test_profiling"
---
...
```{r setup_initializations, eval=TRUE, message=FALSE, results=FALSE, warning=FALSE}
...
data_dir= file.path("C:/Users/Thomas/Documents/GitHub/documentation/test_profiling/data-master/study_case_1/V9.0")
...
```{r gen_dirs, eval=TRUE, results='hide', message=FALSE, warning=FALSE}
...
gen_usms_xml2txt(javastics_path = javastics_path, workspace_path = javastics_workspace_path,
  target_path = stics_inputs_path, display = TRUE)#verbose = TRUE)
print("hey")
```
...
model_options= stics_wrapper_options(stics_path, data_dir = stics_inputs_path, parallel=FALSE)
...
```{r eval=FALSE, echo=FALSE, out.width = '45%'}
...
```{r eval=FALSE, echo=FALSE, message=FALSE, warning=FALSE, out.width = '80%', fig.cap="Figure 2: plots of simulated and observed target variable before and after optimization. The gap between simulated and observed values has been drastically reduced: the minimizer has done its job!"}
knitr::include_graphics("ResultsSimpleCase/sim_obs_plots.png")
```


```{r move_results, eval=FALSE, include=FALSE}
